...
async function loadPageWithoutReset(page, targetRecordId = null) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            console.log(`娓叉煋 ${records.length} 鏉¤褰昤);
            ...
            if (targetRecordId) {
                setTimeout(() => {
                    ...
                    if (targetElement) {
                        ...
                        console.warn(`鏈壘鍒癐D涓?${targetRecordId} 鐨勮褰昤);
                    }
...
function recordReadingProgress() {
    console.log('recordReadingProgress 琚皟鐢?);
    ...
    if (tweetElements.length > 0) {
        ...
        console.log('娌℃湁鎵惧埌鎺ㄦ枃鍏冪礌锛屾棤娉曚繚瀛橀槄璇昏繘搴?);
    }
}
